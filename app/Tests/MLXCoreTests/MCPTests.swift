...
final class MCPTests: XCTestCase {
    ...
    func testCombinedToolsJSONMergesAgentAndMCP() {
        ...
        XCTAssertEqual(arr?.count, 20, "Expected 19 agent tools (incl. createTask, killProcess/readProcessOutput/listProcesses, generate_image/speech/music/video, computer) + 1 MCP tool, got \(arr?.count ?? 0)")
