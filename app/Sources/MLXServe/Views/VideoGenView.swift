        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            if model.supportsChainedWindows {
                ...
                Text(
                    chainWindows > 1
                    ? L10n.format(
                        "%lld windows joined end to end — about %lld frames, and roughly %lldx the time of a single window.",
                        Int64(chainWindows), Int64(numFrames * chainWindows), Int64(chainWindows))
