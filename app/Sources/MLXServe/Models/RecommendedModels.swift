...
extension RecommendedModelPick {
    static let gemmaE2B = RecommendedModelPick(
        id: "gemma-4-e2b",
        name: "Gemma 4 E2B",
        tagline: String(localized: "Small and capable"),
        blurb: String(localized: "A well-rounded everyday assistant — good at chatting, answering questions, and simple coding help, while staying small and fast to run."),
    ...
    static let gemmaE4B = RecommendedModelPick(
        id: "gemma-4-e4b",
        name: "Gemma 4 E4B",
        tagline: String(localized: "The sweet spot"),
        blurb: String(localized: "A clear step up in quality from E2B — better at longer conversations, writing, and coding — while still replying quickly. A great all-around default if you're not sure what to pick."),
    ...
    static let gemma12B = RecommendedModelPick(
        id: "gemma-4-12b",
        name: "Gemma 4 12B",
        tagline: String(localized: "Sharper reasoning"),
        blurb: String(localized: "Noticeably better at following detailed, multi-step instructions and reasoning through trickier problems than the smaller Gemma models, without needing a huge amount of memory."),
    ...
    static let gemma26bA4b = RecommendedModelPick(
        ...
        tagline: String(localized: "Big, but efficient"),
        blurb: String(localized: "A much larger model that uses a trick called \u{201c}mixture of experts\u{201d} — for every word it only wakes up a small part of itself, so it answers faster than you'd expect for its size while giving noticeably better answers than the smaller Gemma models."),
    ...
    static let gemma31B = RecommendedModelPick(
        id: "gemma-4-31b",
        name: "Gemma 4 31B",
        tagline: String(localized: "Gemma's biggest all-rounder"),
        blurb: String(localized: "Gemma's largest single model — every part of it is used on every word, with no shortcuts. Excellent general reasoning, writing, and instruction-following."),
    ...
    static let gemma26bA4b8bit = RecommendedModelPick(
        ...
        tagline: String(localized: "Sharper version of the MoE model"),
        blurb: String(localized: "The same Gemma mixture-of-experts model as above, stored with twice the numeric precision (8-bit instead of 4-bit). That means slightly more accurate, consistent answers, at roughly double the memory."),
    ...
    static let gemma31B8bit = RecommendedModelPick(
        ...
        tagline: String(localized: "The best this app offers"),
        blurb: String(localized: "The highest-quality model on this list: Gemma's largest model at full 8-bit precision. This is about as good as local answers get here — save it for when quality matters more than speed."),
    ...
    static let qwen35_9b = RecommendedModelPick(
        id: "qwen35-9b",
        name: "Qwen 3.5 (9B)",
        tagline: String(localized: "A capable everyday pick"),
        blurb: String(localized: "A well-rounded Qwen model — good at chatting, coding help, and following instructions, while staying quick to respond. A solid alternative to Gemma if you want to compare styles."),
    ...
    static let qwen36_27bMtp = RecommendedModelPick(
        ...
        blurb: String(localized: "One of the most capable models this app can run — excellent at coding and at multi-step \u{201c}agent\u{201d} tasks like using tools and following a plan. It also ships with a built-in speed trick that lets it draft and double-check several words at once, so it feels noticeably faster than a plain model this size."),
    ...
    static let hy3_295b = RecommendedModelPick(
        id: "hy3-oq2e",
        name: "Hunyuan 3 295B",
        tagline: String(localized: "The biggest model here"),
        blurb: String(localized: "Tencent's flagship open model — 295 billion parameters, of which it wakes only 21 billion per word (mixture of experts). Top-tier reasoning, agent work, and tool use, entirely on your Mac. This is the full model stored compactly (importance-calibrated 2-bit), so on a 128 GB Mac it runs with a genuinely usable context window rather than just a few sentences. Best on Macs with 128 GB of memory or more."),
    ...
    static let qwen36_35bA3b = RecommendedModelPick(
        ...
        tagline: String(localized: "Qwen's largest model here"),
        blurb: String(localized: "Qwen's biggest model on this list — 35 billion parameters in total, but like the Gemma mixture-of-experts model above, it only activates a few billion per word, so it stays efficient. Excellent for demanding coding and reasoning work."),
