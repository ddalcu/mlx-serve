...
| `arch/sushi_guest.zig` | sushi guest engine for EXL3 `qwen4_exp` packs: pinned release downloaded on first use, run as a separate process, requests forwarded byte-for-byte, one engine at a time |
